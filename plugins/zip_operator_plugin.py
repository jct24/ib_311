...
class ZipOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        logging.info(f"Path to the File to Zip provided by the User (path_to_file_to_zip): " + str(self.path_to_file_to_zip))
